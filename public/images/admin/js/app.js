    ...
    function t(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (s("#dark-mode-switch").prop("checked", !1),
              ...
              s("#bootstrap-style").attr("href", baseurl+"/public/images/admin/css/bootstrap.min.css"),
              s("#app-style").attr("href", baseurl+"/public/images/admin/css/app.min.css"),
              sessionStorage.setItem("is_visited", "light-mode-switch"))
            : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
            ? (s("#light-mode-switch").prop("checked", !1),
              s("#rtl-mode-switch").prop("checked", !1),
              s("#bootstrap-style").attr("href", baseurl+"/public/images/admin/css/bootstrap-dark.min.css"),
              s("#app-style").attr("href", baseurl+"/public/images/admin/css/app-dark.min.css"),
            ...
            : 1 == s("#rtl-mode-switch").prop("checked") &&
              ...
              s("#dark-mode-switch").prop("checked", !1),
              s("#bootstrap-style").attr("href", baseurl+"/public/images/admin/css/bootstrap.min.css"),
              s("#app-style").attr("href", baseurl+"/public/images/admin/css/app-rtl.min.css"),
