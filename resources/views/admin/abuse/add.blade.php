                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.abuse-words.store')}}" id="abuseForm" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="country">Word</label>
                                                        <input type="text" name="word" placeholder="abuse word" class="form-control" value="{{old('word')}}">
                                                        @error('word')
