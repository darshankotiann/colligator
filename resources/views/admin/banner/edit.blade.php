                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">fill the below details</p>
                            <form action="{{route('admin.banner.update',base64_encode($banner->id))}}" id="bannereditForm" method="post" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" onchange="ChangeUniversityforprofessor()" name="country_code" id="countryCode">
                                            <option value="" selected disabled>Select Country</option>
                                            @foreach($countries as $country)
                                                <option {{$banner->country_code==$country->iso2 ? 'selected' : ''}} value="{{$country->iso2}}" value="{{$country->iso2}}" >{{$country->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('country_code')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 " id="type" name="type">
                                            ...
                                            <option {{$banner->type==1 ? 'selected' : ''}} value="1" >Country</option>
                                            <option {{$banner->type==2 ? 'selected' : ''}} value="2" >University</option>
                                            <option {{$banner->type==3 ? 'selected' : ''}} value="3" id="professoroption">Professor</option>
                                            <option {{$banner->type==4 ? 'selected' : ''}} value="4" >School</option>
                                            <option {{$banner->type==5 ? 'selected' : ''}} value="5" id="teacheroption">Teacher</option>
                                ...
                                <div class="col-md-6" id="Teacherbanner">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="schoolCode" name="school_code">
                                                ...
                                                <option {{$banner->school_code== $school->school_code ? 'selected': ''}} value="{{$school->school_code}}">{{$school->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="form-group">
                                                      ...
                                                      <option value="" selected disabled>Select University</option>
                                                        @foreach ($universities as $university)
                                                            <option
                                                                {{ $banner->university_code == $university->university_code ? 'selected' : '' }}
                                                                value="{{$university->university_code }}">{{ $university->name }}
                                                            </option>
                                                        @endforeach
                                                       <!--  </option> -->
                                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group d-flex">
                                            <input type="text" class="form-control errorvalidator " id="text_en" placeholder="English text" value="{{$banner->text_en}}" name="text_en" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group d-flex">
                                            <input type="text" class="form-control errorvalidator " id="text_ar" placeholder="Arabic text" value="{{$banner->text_ar}}" name="text_ar" >
                                           <!--  <i class="fa fa-info col-1" data-toggle="tooltip" data-placement="bottom"  title="For perfect text alignment add text between 30-40 characters"></i> -->
                                        </div>
                                        @error('text_ar')
                                            <span class="error form-errors mb-0">{{ $message }}</span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <?php $teacherBanner = $banner->image ? 'public/banner/' . $banner->image : 'public/frontend/images/search-prof-bg1.png'; ?>
                                        <?php $mime = mime_content_type($teacherBanner); ?>
                                        @if (strstr($mime, 'image/'))
                                            <img src="{{ asset($teacherBanner) }}" id="userImage" width="100" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="link" placeholder="banner link"  value="{{$banner->link}}" class="form-control">
                                        @error('link')
                                            <span class="error form-errors mb-0">{{ $message }}</span>
                                        @enderror
                                    </div>
