                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.faq.store')}}" id="testimonialForm" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="name">Question (En)</label>
                                                        <input type="text" class="form-control errorvalidator" id="question_en" placeholder="Question in English" value="{{old('question_en')}}" name="question_en" required>
                                                        @error('question_en')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control errorvalidator" id="question_ar" placeholder="Question in Arabic" value="{{old('question_ar')}}" name="question_ar" required>
                                                        @error('question_ar')
                                                            <span class="error form-errors mb-0">{{ $message }}</span>
                                                        @enderror
