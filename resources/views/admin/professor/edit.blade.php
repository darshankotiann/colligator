                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('admin.professor.update',base64_encode($professor->id))}}" id="professorEdit" method="post" enctype="multipart/form-data">
                                            @csrf
                                            {{ method_field('PATCH') }}
                                            
                                            <input type="hidden" id="langtype" value="{{!empty($unilang[0]) ? $unilang[0]->lang_code:''}}">
