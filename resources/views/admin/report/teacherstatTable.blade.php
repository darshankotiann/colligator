<table id="teacherTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    <thead>
        ...
        <tr>
            ...
            <th>Subject</th>
            <th>Rate teacher</th>
            <th>Teacher Review Most Count</th>
            <th>Country</th>
            <th>Created At</th>
            <th>Status</th>
            <th>Action</th>
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><?= number_format($svalue['rateteacher'], 2, ',', ' '); ?></td>
                    <td><?= $svalue['teacher_review_most_count'] ?></td>
    ...
    <tfoot>
        <tr>
            <th colspan="11"><button type="button" class="btn btn-danger merabtn">Delete</button></th>
        </tr>
    </tfoot>
</table>
@if(!empty($teachers))
    ...
    $(document).ready(function() {
        var teachertable = $('#teacherTable').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: "csv",
                    title: "High School Teacher List",
                    exportOptions: {
                ...
                , {
                    ...
                    title: "<center> High School Teacher List</center>",
                    className: "btn-sm prints",
                    footer: true,
                }, 'colvis'
            ],
