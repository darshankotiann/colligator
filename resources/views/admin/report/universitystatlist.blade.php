                        ...
                        <div class="row card-title-desc">
                            ...
                            <div class="form-group mb-0 col-10">
                                ...
                                <div class="row">
                                    ...
                                    <a style="float: right;" class="col-1 btn btn-danger waves-effect waves-light " href="{{route('admin.university_statics')}}">Reset </a>
                                </div>
                                {{ Form::close() }}
                            </div>
...
<script>
    $(document).ready(function() {
        $('#optionsSelected1').change(function() {
            ...
            var url = "https://collegator.com/admin/report/university-statics-filter/" + con + "/" + filter + "/" + limit;
        ...
        $('#limitSelected').change(function() {
            ...
            if (con != null && filter != null) {
                ...
                var url = "https://collegator.com/admin/report/university-statics/" + limit;
                window.location.replace(url);
            }
        });
    });
