...
@endif
                        ...
                        <div class="row card-title-desc">
                            <p class=" col-6 "> List Of all Review.</p>
                            ...
                            <div class="form-group mb-0 col-6">
                                ...
                                <label class="col-3">Range Filter</label>
                                    <div class="input-daterange input-group col-6" data-provide="datepicker" data-date-format="dd M, yyyy" data-date-autoclose="true">
                                     ...
                                     <a style="float: right;" class="col-2 btn btn-danger waves-effect waves-light mr-2" href="{{route('admin.review.index')}}">Reset  </a>
                                </div>
                                {{ Form::close() }}
                            </div>
                        </div>
                        <div class="maintable">
                            @include('admin.review.reviewTable')
                        </div>
                    </div>
                </div>
            </div> <!-- end col -->
