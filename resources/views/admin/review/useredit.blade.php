                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Edit the below details</p>
                                            ...
                                            <div class="col-md-1">
                                                <a href="{{route('admin.userteacher')}}" class="btn btn-primary subbtn mt-2 text-right rounded" type="submit">Back</a>
                                                
                                            </div>
                                        </div>
                                        <form action="{{route('admin.teacher.userupdate',base64_encode($teacherData->id))}}" id="teacherEdit" method="post" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
