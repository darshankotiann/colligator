                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control errorvalidator  checksubjectcode" id="subject_code" placeholder="Subject code" value="{{$subject->subject_code}}" name="subject_code" required>
                                        @error('subject_code')
                                            <span class="error form-errors mb-0">{{ $message }}</span>
                                        @enderror
