<table id="universitySuggestionTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                            <tr>
                                <!-- <th></th> -->
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.university.edit',base64_encode($svalue['university']['id']))}}"><?= $svalue['university']['name'] ?></a></td>
...
<!--                                         <td><div class="badge <?= $svalue['is_delete']==0 ?  'badge-soft-danger' : 'badge-soft-success' ?>   font-size-12  "><?= $svalue['is_delete'] == 0 ? 'Deactive' : 'Active' ?></div></td> -->
                        ...
                        <?php
                                ...
                                <a href="{{route('admin.profile_corrections.universityView',base64_encode($svalue['id']))}}" class="mr-3 text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="mdi mdi-eye font-size-18"></i></a>
                            <?php }
                            else
                            { ?>
                                <a href="{{route('admin.profile_corrections.universityView',base64_encode($svalue['id']))}}" class="mr-3 text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="mdi mdi-eye font-size-18"></i></a>
