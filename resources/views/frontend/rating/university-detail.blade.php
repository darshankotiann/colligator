        ...
        <div class="user-detail-block">
            ...
            <div class="user-detail-info-blk">
                ...
                <div class="user-need-connection">
                     ...
                     <span class="btn-blue-new">
                       <a  href="{{route('frontend.rate_university',base64_encode($university->id))}}" class="checkUser ">{{__('Rate This University!')}}</a>
                     </span>
                     <span class="btn-blue-new">
                                          <a  onclick="return checkAuthUserOnMOdal('add_university')" href="javascript:void(0);" >Duplicate/Correction?</a>
                     </span>
                </div>
            </div>
            <!--user-info-block-->
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="info-item-blk {{App\Helpers\Helper::getColor(round($professor_range/$rowcount,2))}}">
                        <p>{{__('Professors')}}</p>
                        <h3>{{number_format((float)$professor_range/$rowcount, 1, '.', '')}}/10</h3>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="info-item-blk {{App\Helpers\Helper::getColor(round($course_range/$rowcount,2))}}">
                        <p>{{__('Courses')}}</p>
                        <h3>{{number_format((float)$course_range/$rowcount, 1, '.', '')}}/10</h3>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="info-item-blk {{App\Helpers\Helper::getColor(round($facility_range/$rowcount,2))}}">
                        <p>{{__('Facilities')}}</p>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="user-rating-item">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-8 text-right">
                                            <div class="rated-items universityrated-items">
                                                <ul>
                                                    <li><a class="{{App\Helpers\Helper::getColor($ratingData['replyMessage']['professor_range'])}}">{{__('Professors')}} : {{$ratingData['replyMessage']['professor_range']}}</a></li>
                                                    <li><a class="{{App\Helpers\Helper::getColor($ratingData['replyMessage']['course_range'])}}">{{__('Courses')}}: {{$ratingData['replyMessage']['course_range']}}</a></li>
                                                    <li><a class="{{App\Helpers\Helper::getColor($ratingData['replyMessage']['facility_range'])}}">{{__('Facilities')}}: {{$ratingData['replyMessage']['facility_range']}}</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <p class="description">{{str_replace( $abouseWords , "****" , $ratingData['replyMessage']['message'] )}}</p>
                                    @endif
                                    <hr>
                                           ...
                                           <div class="rating-comment-form-blk">
                                                <form action="{{route('frontend.add_university_review')}}" method="post" class="universityReview">
                                                    ...
                                                    <div class="form-group parentnamee university-textarea">
                                                        <div class="childCross"></span></div>
                                                        <div class="counterdiv">

                                                        <textarea onfocusout="hidecounter(this)" onblur="textReplyCounter(this,this.form.counter,200);" onkeyup="textReplyCounter(this,this.form.counter,200);"  name="comment" placeholder="{{__('Write a Reply (max of 200 characters)')}}...." class="form-control main-userclass" rows="1" cols="15" ></textarea>
                                        ...
                                        <ul class="rating_ul_class ">
                                            ...
                                            <li>
                                                <div class="rating-replyed-item">
                                                    ...
                                                    <?php
$color = '';
if ($children['parent_user_name']) {
	$color = $children['genderColor'] == 1 ? '#005BDF' : '#ED0E69';
}
?>
                                                    <p class="description"><span style="color : {{$color}}">{{$children['parent_user_name']? '@'.$children['parent_user_name'].' : ':''}} </span> {{str_replace( $abouseWords , "****" , $children['message'] )}}</p>
                                                    @endif
                                                    <hr>
                                                    <div class="action-links">
                                                        <ul class="changelikeDislikeIcon">
                                                            ...
                                                            <li>
                                                                <a href="javascript:void(0);" class="replyChilde" onclick="replyChildUser(this,'{{base64_encode($children['userData']['id'])}}','{{base64_encode($children['id'])}}','{{($children['id'])}}')">
                                                                    <!-- {{($university->id)}} -->
	...
	$msg = "Are you sure You want to report/spam it";
                                                    ...
                                                    <div class="rating-comment-form-blk">
                                                        <form action="{{route('frontend.add_university_review')}}" method="post" class="universityReview">
                                                            ...
                                                            <input type="hidden" name="id" class="id" value="{{base64_encode($ratingData['replyMessage']['id'])}}">
                                                            <input type="hidden" name="universityId" class="TId" value="{{base64_encode($university->id)}}">
                                                            <div class="form-group parentname child-university chieldsmall-class{{($children['id'])}}" id="childid_{{($university->id)}}">
                                                                ...
                                                                <textarea onfocusout="hidecounter(this)" onblur="textReplyCounter(this,this.form.counter,200);" onkeyup="textReplyCounter(this,this.form.counter,200);"  name="comment" placeholder="{{__('Write a Reply (max of 200 characters)')}}...." class="form-control" rows="1" cols="15" ></textarea>
                                                                <input onblur="textReplyCounter(this.form.recipients,this,200);" disabled  onfocus="this.blur();"  maxlength="3" size="3" value="200 characters remaining" name="counter" class="counterReplyinput">
                                            ...
                                            <div class="rating-comment-form-blk">
                                                <form action="{{route('frontend.add_university_review')}}" method="post" class="universityReview">
                                                    ...
                                                    <div class="form-group parentnamee university-textarea">
                                                        ...
                                                        <div class="counterdiv">
                                                        <textarea onfocusout="hidecounter(this)" onblur="textReplyCounter(this,this.form.counter,200);" onkeyup="textReplyCounter(this,this.form.counter,200);"  name="comment" placeholder="{{__('Write a Reply (max of 200 characters).')}}...." class="form-control replycounter" rows="1" cols="15" ></textarea>
                                                        <input onblur="textReplyCounter(this.form.recipients,this,200);" disabled  onfocus="this.blur();"  maxlength="3" size="3" value="200 characters remaining" name="counter" class="counterReplyinput">
...
function replyChildUser(e,uid,id,test=null) {
    ...
    // $(e).closest('.user-rating-item').find(".rating-comment-form-blk").slideToggle();
