         ...
         <div class="footer-main">
             <div class="row">
                 <div class="col-md-4 footer-logo-box">
                     <a href="{{ route('frontend.home') }}" class="logo-footer"> <img
                 ...
                 <div class="col-md-3 Important links">
                     ...
                     <ul class="footer-link">
                         ...
                         <li> <a
                                 href="{{ route('frontend.slug', 'privacy-policy') }}">{{ __('lang.privacy_policy') }}</a>
                         </li>
                 ...
                 <div class="col-md-3">
                     ...
                     <ul class=" footer-link footer-social">
                         <li class="facebook"><a href="mailto:{{ $global_setting->email }}" target="_blank"><i
                                     class="fas fa-envelope"></i></a></li>
                         <li class="instagram"><a href="{{ $global_setting->instagram }}" target="_blank"><i
                                     class="fab fa-instagram"></i></a></li>
                         <li class="twitter"><a href="{{ $global_setting->twitter }}" target="_blank"><i
             ...
             <div class="modal-header">
                 ...
                 <button type="button" class="close" data-dismiss="modal">
                     <i class="fa fa-times" aria-hidden="true"
                         style="color:#007bff; font-weight: 900; font-size:17px;"></i>
                 </button>
             </div>
                     ...
                     <ul class="nav-right-menu">
                         <li>
                             <span class="btn-blue-new">
                                 <a class="btn btn-blue" href="#" style="padding-top: 3px;"
                                     onclick="callsigninfunction()">{{ __('lang.login') }}</a>
                             </span>
                         </li>
                         <li>
                             <span class="btn-blue-new">
                                 <a class="btn btn-blue" href="#" style="padding-top: 3px;"
                                     onclick="callsignupfunction()">{{ __('lang.signUp') }}</a>
                             </span>
                         </li>
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <div class="login-pop-block">
                     ...
                     <form method="POST" class="form-horizontal" action='#' aria-label="{{ __('lang.login') }}"
                         id="userLogin">
                         @csrf
                         <div class="form-group">
                             <input id="nickname" type="text" class="form-control" name="nickname"
                                 value="{{ old('nickname') }}" required autofocus
                                 placeholder="{{ __('lang.nicknameAddress') }}">
                             @error('nickname')
                         ...
                         <div class="form-group">
                             <input type="password" class="form-control" name="password"
                                 autocomplete="current-password" placeholder="{{ __('lang.password') }}">
                             @error('password')
                                 <span class="invalid-feedback" role="alert">
                                     <strong>{{ $message }}</strong>
                                 </span>
                         ...
                         <div class="remember-box d-flex mb-3">
                             @if (Route::has('password.request'))
                                 <a href="{{ route('password.request') }}" class="ml-auto"><i
                                         class="mdi mdi-lock mr-1"></i>
                                     {{ __('lang.forgotPassword') . '?' }}</a>
                             @endif
                         </div>
                         <button type="button"
                             class="btn btn-blue w-100 mt-2 subbtn loginpopupsubmit">{{ __('lang.login') }}</button>
                         <div class="or-divi">
                             <span>{{ __('Sign in With') }}</span>
                         </div>
                     </form>
                     <div class="login-with-ic">
                         <a href="{{ url('/auth/redirect/facebook') }}" class="btn btn-primary"><img
                                 src="{{ asset('frontend/images/fb.png') }}"></a>
                         <a href="{{ url('/auth/redirect/google') }}" class="btn btn-primary"><img
                                 src="{{ asset('frontend/images/google.png') }}"></a>
                     ...
                     <div class="already-login">
                         <a href="#" onclick="callsignupfunction()">
                             <p><span style="color:black">{{ __('Not Registered Yet') . '?' }}</span>
                                 {{ __('lang.signUp') }}</p>
                         </a>
                     </div>
                     </form>
             ...
             <div class="modal-body">
                 <div class="login-pop-block">
                     ...
                     <form method="POST" class="form-horizontal" action='#'
                         aria-label="{{ __('lang.signup') }}" id="userRegister">
                         @csrf
                         <div class="headings">
                         ...
                         <div class="login-box-form">
                             <div class="form-group">
                                 <input id="email" type="email" placeholder="{{ __('lang.emailAddress') }}"
                             ...
                             <div class="form-group">
                                 <input id="password" type="password" class="form-control "
                                     placeholder="{{ __('lang.password') }}" name="password"
                             ...
                             <div class="form-group">
                                 <input id="password-confirm" type="password" class="form-control"
                                     name="password_confirmation" placeholder="{{ __('lang.confirm_password') }}"
                             ...
                             <div class="custom-control custom-checkbox mt-2 mb-3" style="text-align: initial;"
                                 required>
                                 <input class="custom-control-input" id="registercheckbox" name="registercheckbox"
                                     type="checkbox"><label class="custom-control-label"
                                     for="registercheckbox">{{ __('I Accept the') }}</label> <a
                                     href="{{ route('frontend.slug', 'term-conditions') }}"
                                     target="_blank">{{ __('lang.t&c') }}</a>
                             ...
                             <div class="custom-control custom-checkbox mt-2 mb-3" style="text-align: initial;"
                                 required>
                                 <input class="custom-control-input" id="privacypol" name="privacypol"
                                     type="checkbox"><label class="custom-control-label"
                                     for="privacypol">{{ __('I Accept the') }}</label> <a
                                     href="{{ route('frontend.slug', 'privacy-policy') }}"
                                     target="_blank">{{ __('lang.privacy_policy') }}</a>
                                 <p class="privacypol"></p>
                             </div>

                             <span class="popuperrorprivecycheckbox error d-flex"></span>

                             <button type="button"
                                 class="btn btn-blue w-100 mt-2 subbtn signuppopupsubmit">{{ __('lang.submit') }}</button>
                             <div class="or-divi">
         ...
         if (form.valid()) {
             $.ajax({
                 ...
                 success: function(response) {
                     ...
                     $('.popuperrorprivecycheckbox').text('');
                     var result = response.status;
                     if (result == 'signuperror') {
                         ...
                         if (errors.registercheckbox) {
                             $('.popuperrorregistercheckbox').text(
                                 'please select the term & conditions');
                         }
                         if (errors.privacypol) {
                             $('.popuperrorprivecycheckbox').text(
