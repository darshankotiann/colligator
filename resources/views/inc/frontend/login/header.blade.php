    ...
    <div class="header-nav">
        <div class="container">
            ...
            <nav class="navbar-blk navbar navbar-expand-lg navbar-light">
                ...
                <button class="navbar-toggler collapsed btn-blue" type="button" data-toggle="collapse"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('goLogin') }}">{{ __('lang.login') }}/{{ __('lang.signUp') }}</a> </li>
                        @endauth
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('frontend.home') }}">{{ __('lang.home') }}</a> </li>
                        @auth
                            <li class="nav-item "> <a class="nav-link"
                                    href="{{ route('frontend.my_profile') }}">{{ __('My Profile') }}</a> </li>
                            <li class="nav-item "> <a class="nav-link"
                                    href="{{ route('frontend.change_password') }}">{{ __('Change Password') }}</a> </li>
                        @endauth
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('frontend.aboutUs') }}">{{ __('lang.about_us') }}</a> </li>
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('frontend.contactUs') }}">{{ __('lang.contact_us') }}</a> </li>
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('frontend.slug', 'term-conditions') }}">{{ __('Terms and Conditions') }}</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('frontend.slug', 'privacy-policy') }}">{{ __('Privacy Policy') }}</a>
                        </li>
                        @auth
                            <li class="nav-item ">
                                @php
                ...
                @auth
                    <div class="nav-right after-login">
                        <ul class="nav-right-menu">
                            @if ($global_setting->private_message == 1)
                                <li class="btn-blue-new">
                                    @if (isset($globalconversation[0]))
                                        <a href="{{ route('frontend.chat.list', $globalconversation[0]['userId']) }}"
                                            class="mobile-view-msg">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="26.633" height="19.975"
                                                viewBox="0 0 26.633 19.975">
                                                <g id="envelope" transform="translate(0 -64)">
                                                    <g id="Group_27074" data-name="Group 27074" transform="translate(0 64)">
                                                        <g id="Group_27073" data-name="Group 27073"
                                                            transform="translate(0 0)">
                                                            <path id="Path_19090" data-name="Path 19090"
                                                                d="M7.11,65.621c3.655,3.1,10.069,8.542,11.954,10.24a1.114,1.114,0,0,0,1.611,0c1.887-1.7,8.3-7.146,11.956-10.242a.554.554,0,0,0,.078-.766A2.2,2.2,0,0,0,30.968,64H8.773a2.2,2.2,0,0,0-1.742.855A.554.554,0,0,0,7.11,65.621Z"
                                                                transform="translate(-6.554 -64)" fill="#fff" />
                                                            <path id="Path_19091" data-name="Path 19091"
                                                                d="M26.311,126.463a.552.552,0,0,0-.592.08c-4.054,3.436-9.227,7.841-10.855,9.308a2.247,2.247,0,0,1-3.1,0c-1.735-1.563-7.545-6.5-10.854-9.307a.555.555,0,0,0-.914.423v13.954a2.222,2.222,0,0,0,2.219,2.219H24.414a2.222,2.222,0,0,0,2.219-2.219V126.967A.555.555,0,0,0,26.311,126.463Z"
                                                                transform="translate(0 -123.165)" fill="#fff" />
                                                        </g>
                                                    </g>
                                                </g>
                                            </svg>
                                    ...
                                    <div class="dropdown removebtnmodal">
                                        <button class="dropbtn info-dropdown btn-blue">

                                            <span class="info-dropdown-item countmessages">0</span>
                                        ...
                                        <div class="dropdown-content">
                                            <div
                                                class="dropdown-notification-blk dropdown-notification-blk-chat chatify-msg-notify">

                                                {{-- @if (count($globalconversation) > 0) --}}
                                                <ul>
                                                    {{-- @foreach ($globalconversation as $conversation)
                                                            <li
                                                                class="{{ $conversation['messages_count'] > 0 ? 'newChat' : '' }}">
                                                                <a href="{{ route('frontend.one-chat', $conversation['userId']) }}"
                                                                    class="dropdown-notification-item">
                                                                    <div class="dropdown-notification-icon">
                                                                        <figure class="obj-fit">
                                                                            <img
                                                                                src="{{ asset('profile/colleicon.png') }}">
                                                                        </figure>
                                                                    </div>
                                                                    <div class="dropdown-notification-item-info">
                                                                        <div class="notification-item-message">
                                                                            {{ $conversation['username'] ?? 'No User' }}
                                                                            @if ($conversation['messages_count'] > 0)
                                                                                <span
                                                                                    class="badge badge-secondary">{{ $conversation['messages_count'] }}</span>
                                                                            @endif
                                                                        </div>
                                                                        <div class="notification-item-time">
                                                                            {{ $conversation['messages_count'] > 0 ? 'Now' : '' }}
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                ...
                                                <a href="{{ url('/chatify') }}" class="dropdown-view-all-btn">View
                                                    all
                                                    Message</a>
                            ...
                            <li class="btn-blue-new">
                                <a class="mobile-view-bell" href="{{ route('frontend.notification.index') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="notification-bell" width="25.265"
                                        height="25.265" viewBox="0 0 25.265 25.265">
                                        <path id="Path_19052" data-name="Path 19052" d="M0,0H25.265V25.265H0Z"
                                            fill="none" />
                                        <path id="Path_19053" data-name="Path 19053"
                                            d="M20.869,19.545l.421.561a.526.526,0,0,1-.421.842H4.026a.526.526,0,0,1-.421-.842l.421-.561V10.422a8.422,8.422,0,0,1,16.843,0ZM9.816,22H15.08a2.632,2.632,0,1,1-5.263,0Z"
                                            transform="translate(0.184 0.105)" fill="#fff" />
                                    </svg>
                                        ...
                                        <div class="dropdown-notification-blk">
                                            @if (count($globalnotification) > 0)
                                                ...
                                                <a href="{{ route('frontend.notification.index') }}"
                                                    class="dropdown-view-all-btn">View all Notifications</a>
                                            @else
                        ...
                        @if ($global_setting['show_language'] == 1)
                            ...
                            <a href="{{ route('lang', session()->get('locale')) }}"
                                class="lang-btn">{{ session()->get('locale') == 'en' ? 'عربى' : 'English' }}
                                <span></span></a>
                            <?php }else{ ?>
