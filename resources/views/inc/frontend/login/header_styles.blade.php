    ...
    <link rel="stylesheet" href="{{ asset('frontend/fonts/remixicon.css') }}" />
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />

    <link rel="stylesheet" href="{{ asset('frontend/css/style.css') }}" />
    </head>
    <link rel="stylesheet" href="{{ asset('frontend/css/responsive-css.css') }}" />
    ...
    <script src="{{ asset('frontend/js/custom-functions.js') }}"></script>
