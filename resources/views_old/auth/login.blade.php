                ...
                <div class="login-box">
                    ...
                    <div class="login-box-form">
                        ...
                        <div class="form-group">
                            <input id="nickname" type="text" class="form-control @error('nickname') is-invalid @enderror" name="nickname" value="{{ old('nickname') }}" required  autofocus   placeholder="{{ __('lang.nicknameAddress') }}" >
                            @error('nickname')
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" autocomplete="current-password" placeholder="{{ __('lang.password') }}" >
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <button class="btn btn-blue w-100 mt-2 subbtn">{{__('lang.login') }}</button>
