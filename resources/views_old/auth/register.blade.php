                ...
                <div class="login-box signup-box">
                    ...
                    <div class="login-box-form">
                        <div class="form-group">
                            <input id="email" type="email" placeholder="{{ __('lang.emailAddress') }}" class="form-control " name="email" value="{{ old('email') }}" required autocomplete="email">
                            @error('email')
                        ...
                        <div class="row"> 
                            ...
                            {{--<div class="col-md-12">
                                <div class="form-group">
                                    <input id="nickname" type="text" class="form-control " name="nickname" value="{{ old('nickname') }}" placeholder="{{ __('lang.nickname') }}" required autocomplete="nickname" autofocus>
                        ...
                        <div class="form-group">
                            <input id="password" type="password" class="form-control" placeholder="{{__('lang.password')}}" name="password" required autocomplete="new-password" id="password">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required placeholder="{{__('lang.confirm_password')}}" autocomplete="new-password">
                        </div>
