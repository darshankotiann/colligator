                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="{{ Request::segment(2)=='sub-admin' || Request::segment(2)=='users'  ? 'mm-active' : '' }} ">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                    <li  class="{{ Request::segment(2)=='sub-admin'   ? 'mm-active' : '' }} "><a  class="{{ Request::segment(2)=='sub-admin' ? 'active' : '' }} " href="{{route('admin.subadmin.list')}}">Sub Admin</a></li>

                                    <?php } ?>
                                    <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'Users'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                    <li  class="{{Request::segment(2)=='users'  ? 'mm-active' : '' }} "><a  class="{{ Request::segment(2)=='users'  ? 'active' : '' }} " href="{{route('admin.user.list')}}">Users</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            ...
                            <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'Cms'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                            <li class="{{ Request::segment(2)=='cms-list' ||Request::segment(2)=='cms-edit' ||Request::segment(2)=='about-us' ||Request::segment(2)=='contact-us'  ? 'mm-active' : '' }} ">
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <?php } ?>
                                ...
                                <li class="{{ Request::segment(2)=='university' || Request::segment(2)=='college' || Request::segment(2)=='school' || Request::segment(2)=='subject' ? 'mm-active' : '' }} ">
                                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                                        <i class="mdi mdi-school"></i>
                            ...
                            <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'University'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                             <li  class="{{ Request::segment(2)=='university' ? 'mm-active' : '' }} "><a class="{{  Request::segment(2)=='college' ? 'active' : '' }} " href="{{route('admin.university.index')}}">University</a></li>
                                            <?php } ?>
                            <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'College'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                        <li  class="{{  Request::segment(2)=='college' ? 'mm-active' : '' }} " ><a class="{{  Request::segment(2)=='college' ? 'active' : '' }} " href="{{route('admin.college.index')}}">College</a></li>
                                    
                                        <?php } ?>
                            <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'School'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                        <li  class="{{Request::segment(2)=='school'  ? 'mm-active' : '' }} "><a class="{{Request::segment(2)=='school'  ? 'active' : '' }} " href="{{route('admin.school.index')}}">School</a></li>
                                    
                                        <?php } ?>
                            <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'Subject'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                        <li  class="{{ Request::segment(2)=='subject' ? 'mm-active' : '' }} "><a class="{{ Request::segment(2)=='subject' ? 'active' : '' }} " href="{{route('admin.subject.index')}}">Subject</a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                             <li class="{{ Request::segment(2)=='professor' || Request::segment(2)=='teacher' ? 'mm-active' : '' }} ">
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="mdi mdi-school"></i>
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    ...
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                    <li class="{{ Request::segment(2)=='professor'  ? 'mm-active' : '' }}"><a class="{{ Request::segment(2)=='professor'  ? 'active' : '' }}" href="{{route('admin.professor.index')}}">Professor</a></li>
                                    <li class="{{ Request::segment(2)=='user-professor'  ? 'mm-active' : '' }}"><a class="{{ Request::segment(2)=='user-professor'  ? 'active' : '' }}" href="{{route('admin.userprofessor')}}">User Created Professor</a></li>
                                    
                                    <?php } ?>
                                    <?php $permissions= Permissions::where(['subadmin_id'=>Auth::guard('admin')->user()->id,'modal_name'=>'HighSchoolProfile'])->first();
                                    if($permissions['add']==1 ||$permissions['edit']==1 ||$permissions['delete']==1 ){
                                     ?>
                                    <li class="{{ Request::segment(2) == 'teacher' ? 'mm-active' : '' }}"><a class="{{ Request::segment(2) == 'teacher' ? 'active' : '' }}" href="{{route('admin.teacher.index')}}">High School</a></li>

                                    <li class="{{ Request::segment(2) == 'user-teacher' ? 'mm-active' : '' }}"><a class="{{ Request::segment(2) == 'user-teacher' ? 'active' : '' }}" href="{{route('admin.userteacher')}}">User Created High School</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            ...
                            <li class="{{ Request::segment(2)=='professor-review' || Request::segment(2)=='teacher-review'|| Request::segment(2)=='professor-review-edit'|| Request::segment(2)=='professor-review-view'|| Request::segment(2)=='teacher-review-edit'|| Request::segment(2)=='teacher-review-view'|| Request::segment(2)=='university-review'|| Request::segment(2)=='university-review-edit'|| Request::segment(2)=='university-review-view'|| Request::segment(2)=='teacher-profile-corrections'|| Request::segment(2)=='view-teacher-profile-corrections'|| Request::segment(2)=='professor-profile-corrections'|| Request::segment(2)=='view-professor-profile-corrections'|| Request::segment(2)=='university-profile-corrections'|| Request::segment(2)=='view-university-profile-corrections'|| Request::segment(2)=='report-spam'|| Request::segment(2)=='teacher-review-edit'|| Request::segment(2)=='teacher-review-view'|| Request::segment(2)=='professor-review-edit'|| Request::segment(2)=='professor-review-view'|| Request::segment(2)=='university-review-edit' ? 'mm-active' : '' }}">
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="true">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu" aria-expanded="false">
                                            <li><a href="{{route('admin.profile_corrections.teacherList')}}">Corrections</a></li>
